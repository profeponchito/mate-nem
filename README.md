...
20. ⏳ Página de verificación de folios (`verificar.html`) enlazada desde el QR.
21. ⏳ Trimestres 2 y 3 (ejes "Forma, espacio y medida" y "Análisis de datos y probabilidad") para los PDAs por grado.
22. ⏳ Desplegar el Web Endpoint real, configurar `WEBHOOK_URL` y subir a GitHub Pages.
23. ⏳ Pruebas en dispositivos móviles reales.

...
19. ⏳ Página de verificación de folios (`verificar.html`) enlazada desde el QR.
20. ⏳ Trimestres 2 y 3 (ejes "Forma, espacio y medida" y "Análisis de datos y probabilidad") para los PDAs por grado.
21. ⏳ Desplegar el Web Endpoint real, configurar `WEBHOOK_URL` y subir a GitHub Pages.
22. ⏳ Pruebas en dispositivos móviles reales.

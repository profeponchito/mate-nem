 ...
 *   puntaje, puntajeMax, estrellas, estrellasMax, codigoVerificacion, fecha
 * }
 */
    ...
    <div id="constancia" class="constancia">
      <div class="constancia__marco">
        ...
        <div class="constancia__resultados">
          <span>Puntaje: <strong>${datos.puntaje ?? '—'}${datos.puntajeMax != null ? ` de ${datos.puntajeMax}` : ''}</strong></span>
